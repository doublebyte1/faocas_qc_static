...
void FrmTip::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        FrmTip *_t = static_cast<FrmTip *>(_o);
        switch (_id) {
        case 0: _t->showStartupMsg((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData FrmTip::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FrmTip::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FrmTip,
      qt_meta_data_FrmTip, &staticMetaObjectExtraData }
};
