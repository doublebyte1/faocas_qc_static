...
void frmlu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        frmlu *_t = static_cast<frmlu *>(_o);
        switch (_id) {
        case 0: _t->LU((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: _t->emitLU(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData frmlu::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject frmlu::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_frmlu,
      qt_meta_data_frmlu, &staticMetaObjectExtraData }
};
